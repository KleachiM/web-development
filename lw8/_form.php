<section class="form-section">
  ...
  <form method="POST" action="form-handl.php" enctype="x-www-formd-data" class="form-section__form">
    <input required type="text" name="username" placeholder="Ваше имя" class="form__input" value={%username%}>
    <input required type="email" name="email" placeholder="Email" class="form__input" value={%email%}>
